...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/lhh/computer_arch/final_lab/riscv-core/test_run_dir/Threestage_Pipelined_CPU_should_calculate_recursively_fibonacci10_and_generate_signature_file/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/lhh/computer_arch/final_lab/riscv-core/test_run_dir/Threestage_Pipelined_CPU_should_calculate_recursively_fibonacci10_and_generate_signature_file/TestTopModule.)";
