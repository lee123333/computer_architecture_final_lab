...
#define TOP_CLASS VPipelineRegister
...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/lhh/computer_arch/final_lab/riscv-core/test_run_dir/Pipeline_Register_should_be_able_to_stall_and_flush/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_stall = u; break;
      case 2 : dut->io_flush = u; break;
      case 3 : dut->io_in = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_stall; break;
      case 2 : value = dut->io_flush; break;
      case 3 : value = dut->io_in; break;
      case 4 : value = dut->io_out; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/lhh/computer_arch/final_lab/riscv-core/test_run_dir/Pipeline_Register_should_be_able_to_stall_and_flush/PipelineRegister.)";
