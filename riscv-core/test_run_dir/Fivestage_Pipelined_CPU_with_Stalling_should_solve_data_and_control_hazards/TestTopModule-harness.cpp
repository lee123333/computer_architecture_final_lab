...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/lhh/computer_arch/final_lab/riscv-core/test_run_dir/Fivestage_Pipelined_CPU_with_Stalling_should_solve_data_and_control_hazards/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/lhh/computer_arch/final_lab/riscv-core/test_run_dir/Fivestage_Pipelined_CPU_with_Stalling_should_solve_data_and_control_hazards/TestTopModule.)";
