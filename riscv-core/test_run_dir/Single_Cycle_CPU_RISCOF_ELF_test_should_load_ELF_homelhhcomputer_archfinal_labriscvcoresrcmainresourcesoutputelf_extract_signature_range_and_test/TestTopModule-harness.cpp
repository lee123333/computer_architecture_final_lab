...
#define TOP_CLASS VTestTopModule
...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/lhh/computer_arch/final_lab/riscv-core/test_run_dir/Single_Cycle_CPU_RISCOF_ELF_test_should_load_ELF_homelhhcomputer_archfinal_labriscvcoresrcmainresourcesoutputelf_extract_signature_range_and_test/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_regs_debug_read_address = u; break;
      case 2 : dut->io_mem_debug_read_address = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_regs_debug_read_address; break;
      case 2 : value = dut->io_mem_debug_read_address; break;
      case 3 : value = dut->io_regs_debug_read_data; break;
      case 4 : value = dut->io_mem_debug_read_data; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/lhh/computer_arch/final_lab/riscv-core/test_run_dir/Single_Cycle_CPU_RISCOF_ELF_test_should_load_ELF_homelhhcomputer_archfinal_labriscvcoresrcmainresourcesoutputelf_extract_signature_range_and_test/TestTopModule.)";
