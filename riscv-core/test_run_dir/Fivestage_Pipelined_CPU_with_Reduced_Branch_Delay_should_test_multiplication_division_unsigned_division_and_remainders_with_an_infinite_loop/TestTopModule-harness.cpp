...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/lhh/computer_arch/final_lab/riscv-core/test_run_dir/Fivestage_Pipelined_CPU_with_Reduced_Branch_Delay_should_test_multiplication_division_unsigned_division_and_remainders_with_an_infinite_loop/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/lhh/computer_arch/final_lab/riscv-core/test_run_dir/Fivestage_Pipelined_CPU_with_Reduced_Branch_Delay_should_test_multiplication_division_unsigned_division_and_remainders_with_an_infinite_loop/TestTopModule.)";
