...
class my_dut(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","my_dut")
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for my_dut start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
    ...
    def runTests(self, testList):
      ...
      for testname in testList:
        ...
        #   elf = 'my.elf'
          elf = os.path.join(testentry['work_dir'], 'output.elf')
          ...
          asmbin = os.path.join('/home/lhh/computer_arch/final_lab/riscv-core/src/main/resources/', 'output.asmbin')
	  ...
	  # echo statement.
          if self.target_run:
            ...
            simcmd = 'echo "NO RUN"'
# sbt -DelfFile=/home/lhh/computer_arch/final_lab/riscv-core/src/main/resources/output.elf -DsignatureFile=result.signature "testOnly riscv.test "
        ...
        #   execute = f'@cd /home/lhh/computer_arch/final_lab/riscv-core; {cmd}; {objcopy_cmd}; {simcmd};'
